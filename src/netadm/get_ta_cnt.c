 ...
 *
 * Module Function:
 * 	A RPC call to return the number of integral TA ports on an
 *	Annex.
 *
 * Original Author: James Carlson	Created on: 3 January 1996
 *
 ***********************************************************************
 */
...
get_ta_count(Pinet_addr, type, Pdata)
...

{
    ...
    return rpc(Pinet_addr, RPROC_GET_TAS, OUTGOING_COUNT, outgoing,
	       Pdata, type);
