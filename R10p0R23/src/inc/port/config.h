 ...
 *
 * $Header: /annex/common/src/./inc/port/RCS/config.h,v 1.1 1989/04/05 14:42:40 root Rel $
 *
 * This file created by RCS from $Source: /annex/common/src/./inc/port/RCS/config.h,v $
 *
 * Revision History:
 *
 * $Log: config.h,v $
