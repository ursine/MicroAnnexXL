 ...
 * $Id: get_if_param.c,v 1.1.5.1 1995/08/16 13:30:52 slu Exp $
 *
 * This file created by RCS from
 * $Source: /annex/common/src/./netadm/RCS/get_if_param.c,v $
 * 
 * Revision History:
 * $Log: get_if_param.c,v $
 * Revision 1.1.5.1  1995/08/16  13:30:52  slu
 * Support NT.
 *
 * Revision 1.1  1993/01/22  18:21:48  wang
 * Initial revision
 *
...
#define RCSDATE $Date: 1995/08/16 13:30:52 $
#define RCSREV  $Revision: 1.1.5.1 $
#define RCSID   "$Header: /annex/common/src/./netadm/RCS/get_if_param.c,v 1.1.5.1 1995/08/16 13:30:52 slu Exp $"
#ifndef lint
...
get_if_param(Pinet_addr, device_type, line_number, cat, number, type, Pdata)
...

{
    ...
    return rpc(Pinet_addr, RPROC_GET_IF_PARAM, OUTGOING_COUNT, outgoing,
	       Pdata, type);
